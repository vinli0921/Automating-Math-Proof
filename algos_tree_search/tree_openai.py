...
class TreeSearchProofGenerator(VotingProofGenerator):
    ...
    def __init__(self,
        ...
        self.refinement_prompt = ChatPromptTemplate.from_messages([
            ("user", """You are a mathematics expert refining proofs.

Given a mathematical proof attempt, generate a refined version that addresses any gaps or weaknesses.
Original Proof:
{proof}
...
if __name__ == "__main__":
    ...
    try:
        ...
        prover = TwoAgentProver(
            ...
            max_attempts=1,
            log_file='ms_o1_tree26_graph.csv'
        )
        
        results = run_evaluation(
            prover,
            test_cases,
            'ms_o1_tree26_graph.json'
        )
